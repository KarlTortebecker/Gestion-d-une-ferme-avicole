...
<a href="https://api.whatsapp.com/send?phone=23756302780&text=Hi%20Karl,%20About%20the%20RedCock%20Farm.%20I%20need%20your%20help%20please." class="float" target="_blank">
            ...
            <div class="col-md-6 stretch-card grid-margin">
              ...
              <div class="col-md-6">
                <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                  ...
                  $sql="SELECT * from  tblcompany where developer='Karl Tortebecker'";
                  $query = $dbh -> prepare($sql);
